...
/* Encoder */
    ...
    int16_t Encoder_GetEmulatorButton();
    bool Encoder_GetIsPush();
    void Encoder_SetEnable(bool en);
    bool Encoder_GetIsPush();   //Button A

/* Button */
    void Button_Init();
    void Button_Update();
    int8_t Button_GetIsPush();
    void Button_SetEnable(bool en);
    bool Button_GetIsPushA();   //Button A
    bool Button_GetIsPushB();   //Button B
    bool Button_GetIsPushC();   //Button C
